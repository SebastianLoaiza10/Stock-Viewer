...
namespace Project2
{
    public static class isDownwardWave
    {
        /// <summary>
        /// The purpose of this method is to check if the wave is downward
        ...
        /// If the high and low values of the end candlestick are less than the start candlestick, the wave is downward.
        /// </summary>
        /// <param name="smartCandlesticks">The list of candlesticks.</param>
        ...
        /// <returns>True if the wave is downward,otherwise, false.</returns>
        public static bool IsDownwardWave(List<SmartCandlestick> smartCandlesticks, int startIndex, int endIndex)
        {
            ...
            // Determine if the wave is downward by comparing the high and low values of the start and end candlesticks
